...
## Formalismo HQCB (acción + ecuaciones + puente LQG/LQC + bootstrap)

El formalismo mínimo consistente de la hipótesis HQCB (acción, ecuaciones de campo, conexión efectiva con LQG/LQC y cierre bootstrap) está documentado aquí:
